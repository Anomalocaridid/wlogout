...
1. Copy the contents of the desired flavor's css file to `~/.config/wlogout/style.css`.
2. Copy the icons corresponding to the desired flavor from either [./icons/wlogout](./icons/wlogout) or [./icons/wleave](./icons/wleave) to `~/.config/wlogout/`.
